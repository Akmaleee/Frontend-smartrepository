...
import { 
  ...
  Bot,
  Clock,
  X // <-- Import X untuk tombol close pada modal
} from "lucide-react";
...
//   Trash2,
//   Edit3,
//   ShieldCheck, // Icon untuk watermark
//   ShieldAlert,
//   Bot,         // Icon untuk AI
//   Clock
// } from "lucide-react";
...
// // Tambahkan ai_status dan is_watermarked ke interface
// interface Document {
//   id: string;
//   title: string;
//   author: string;
...
//                   {/* Highlight */}
//                   <p className="text-gray-600 text-sm line-clamp-2 leading-relaxed italic">
//                     {doc.highlight || "Ringkasan otomatis belum tersedia."}
//                   </p>
