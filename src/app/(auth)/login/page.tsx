...
//             <Image 
//               src={logoRepository} 
//               alt="Ilustrasi Smart Repository" 
//               className="w-full h-auto object-contain"
//               priority
//             />
//           </div>
...
//           </h1>
//           <p className="text-slate-500 leading-relaxed text-lg max-w-md mx-auto">
//             Sistem manajemen dokumen kemitraan cerdas. Temukan, kelola, dan bagikan literatur akademik dengan lebih efisien.
//           </p>
//         </div>
//       </div>
...
//             <div className="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 mb-2 flex justify-center items-center w-28 h-28">
//               <Image 
//                 src={logoPnj} 
//                 alt="Logo PNJ" 
//                 className="w-full h-full object-contain"
...
//                     value={formData.password}
//                     onChange={(e) => setFormData({...formData, password: e.target.value})}
//                     // Tambahkan pr-11 agar teks tidak menabrak ikon mata di sebelah kanan
//                     className="pl-11 pr-11 h-12 bg-gray-50/50 border-gray-200 focus:bg-white focus:ring-2 focus:ring-blue-500 transition-all rounded-xl w-full"
//                   />
//                   {/* Tombol Toggle Mata */}
//                   <button
